...
" Revision #5: Switch main text from yellow to yellow for easier contrast,
...
hi comment		guifg=yellow		ctermfg=yellow	ctermbg=black	gui=bold 
hi constant		guifg=yellow		ctermfg=yellow
